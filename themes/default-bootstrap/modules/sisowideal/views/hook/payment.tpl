...
<div class="row">
	<div class="col-xs-12 col-md-6">
        <p class="payment_module sisow">
			<a href="javascript:void(0)" onclick="$('#sisow_{$paymentcode}_form').submit();"  class="sisowideal" id="sisow{$paymentcode}_process_payment" title="{l s='Pay with iDEAL' mod='sisowideal'}">
